...
class TestCase
{
     ...
     *
     * @param string $test The self_Assert method to call.
     *
    ...
    {
        $message = get_class($this) . ' test fail: ' . $text . "\n";
        $message .= (isset($info['actual'])) ? 'Actual: ' . $info['actual'] . "\n" : '';
        $message .= (isset($info['expect'])) ? 'Ectual: ' . $info['expect'] . "\n" : '';
        throw new Exception($message);
        /*
        $info['exit'] = self::EXIT_FAIL;
        throw Solar::factory('self_Exception_Fail', array(
    ...
    {
        $info['exit'] = self::EXIT_TODO;
        throw Solar::factory('self_Exception_Todo', array(
            'class' => get_class($this),
            'code'  => 'ERR_TODO',
            'text'  => $text,
            'info'  => $info,
    ...
    {
        $info['exit'] = self::EXIT_SKIP;
        throw Solar::factory('self_Exception_Skip', array(
            'class' => get_class($this),
            'code'  => 'ERR_SKIP',
            'text'  => $text,
            'info'  => $info,
